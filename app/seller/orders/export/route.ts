...
export async function GET(request: Request) {
  ...
  return csvResponse(`ringo-orders-${zonedDateKey()}.csv`, [
    ...
    ...rows.map((o) => [o.orderNo, zonedStamp(o.createdAt), zonedStamp(o.paidAt), o.status, o.fulfillmentStatus, o.refundStatus, o.productTitle, o.buyerName, o.buyerEmail, o.currency, major(o.subtotalCents), major(o.discountCents), o.couponCode ?? "", major(o.totalCents), major(o.commissionCents), major(o.sellerNetCents), major(o.refundedCents), o.source ?? "", o.medium ?? "", o.campaign ?? "", zonedStamp(o.dueAt), zonedStamp(o.deliveredAt), o.settlementId ? "yes" : "no"]),
  ]);
}
